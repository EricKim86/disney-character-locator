...
function characterDisplay() {
    ...
    fetch(characterFetch)
        ...
        .then(function (data) {
            ...
            var disneyFilmTitle = data.data[0].films;
            ...
            var reviewApiTitle = 'https://api.themoviedb.org/3/search/movie?api_key=' + apiKey + '&query=' + disneyFilmTitle;
            console.log(reviewApiTitle);
